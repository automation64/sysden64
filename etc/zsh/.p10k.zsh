# Warning: configuration file generated by SysAdmin64. DO NOT MODIFY
# Version: 1.0.0
...
() {
  ...
  function prompt_sysadmin64() {
    p10k segment -f black -b blue -i '⭐' -t 'SYSADMIN64-CONTAINER'
  }
