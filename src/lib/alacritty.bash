...
function module_alacritty_setup() {
  ...
  local module_name='alacritty'
  local module_etc=''

  module_detect "$module_name" 'alacritty' 'Alacritty - Terminal Emulator' || return 0

  module_etc="$(module_config_get_source "$module_type" "$module_name")" &&
    module_alacritty_setup_config "$home" "$module_etc" "$module_name" "$module_type"
}
...
function module_alacritty_setup_config() {
  ...
  local module_config='.alacritty.toml'
  local config_legacy='.alacritty.yml'
  local config_backup="${config_destination}/${module_config}"
  local target_legacy="${config_destination}/${config_legacy}"
