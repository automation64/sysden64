...
function module_vscodium_setup_config() {
  ...
  if [[ "$BL64_OS_TYPE" == "$BL64_OS_TYPE_LINUX" ]]; then
    config_destination="${home}/.config/VSCodium"
    bl64_fs_dir_create \
