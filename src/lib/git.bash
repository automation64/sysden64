...
function module_git_setup() {
  ...
  local module_name='git'
  local module_etc=''

  module_detect "$module_name" 'git' 'GIT - CLI' || return 0

  module_etc="$(module_config_get_source "$module_type" "$module_name")" &&
    module_git_setup_config "$home" "$module_etc" "$module_name" "$module_type"
}
